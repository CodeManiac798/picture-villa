  ...
  return (
    ...
    >
      ...
      <div className={cn('relative overflow-hidden rounded-[var(--radius-card)] bg-[--color-beige] shadow-[0_20px_50px_-24px_rgba(40,24,16,0.4)]', aspectClasses[aspect])}>
        ...
        {/* Caption scrim — deepens on hover */}
        <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-[#1a120c]/70 via-[#1a120c]/10 to-transparent opacity-90 transition-opacity duration-500 group-hover:opacity-100" aria-hidden="true" />
